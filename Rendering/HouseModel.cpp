...
bool HouseModel::Initialize(ID3D11Device* device)
{
	...
	vertexCount = 3 * (5*2 + 4); //5 quads, 4 triangles
...
void HouseModel::Render(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
int HouseModel::GetIndexCount()
{
	return m_indexCount;
}

VectorType* HouseModel::GetVertexList()
{
	return m_vertexList;
}

int HouseModel::GetVertexCount()
{
